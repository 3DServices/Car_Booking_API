...
urlpatterns = [
    ...
    path('departmenttrips/', include(api_urls.department_trip_urls)),
    path('departmentpassengertrips/',
         include(api_urls.department_passengertrip_urls)),
    path('departmentpassengers/', include(api_urls.department_passenger_urls)),
    path('departmentdrivers/', include(api_urls.department_driver_urls)),
