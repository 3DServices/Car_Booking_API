...
schema_view = get_schema_view(
    openapi.Info(
        title="car_booking_api",
        default_version='v1',
        description="Welcome to the car booking app api",
        terms_of_service="https://www.3dservices.co.ug",
        contact=openapi.Contact(email="jacob@3dservices.co.ug"),
        license=openapi.License(name="Awesome stuff"),
    ),
    public=True,
