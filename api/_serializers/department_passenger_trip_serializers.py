...
class CreateDepartmentPassengerTripSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'department', 'vehicle', 'driver', 'pick_up_location',
    ...
    def create(self, validated_data):
        try:
            ...
            department_passenger_trip_instance = api_models.DepartmentPassengerTrip.objects.create(
                passenger_trip=passenger_trip_instance,
                department=department_instances[0],
            )

            return department_passenger_trip_instance
...
class UpdateDepartmentPassengerTripSerializer(ModelSerializer):
